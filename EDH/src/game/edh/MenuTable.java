...
public class MenuTable extends BaseTable {
	...
	public MenuTable(EdhGame game, BaseScreen screen, Table mainTable) {
	...
	private void setTable() {
		...
		start.addListener(new ClickListener() {
			...
			public void clicked(InputEvent event, float x, float y) {
				...
				changeTable(new StageTable(edh, screen, mainTable));
			}
		});
		...
		setting.addListener(new ClickListener() {
			...
			public void clicked(InputEvent event, float x, float y) {
				...
				changeTable(new SettingTable(screen, mainTable, edh));
			}
		});
		...
		help.addListener(new ClickListener() {
			...
			public void clicked(InputEvent event, float x, float y) {
				...
				screen.changeScreen(new LoadScreen(edh, LoadScreen.NextScreen.Event));
			}
		});
