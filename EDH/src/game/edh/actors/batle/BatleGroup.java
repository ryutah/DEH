 ...
 *
 */
public abstract class BatleGroup extends Group{
	...
	public float scaleX = Gdx.graphics.getWidth() / 432f;
	public float scaleY = Gdx.graphics.getHeight() / 768f;
	
	protected float clearFlag;
	protected float clearCount;
	
	OrthographicCamera cam;
	Matrix4 matrix;
	Vector3 v3;
	BatlePlayer player;
	protected Pool<Enemy> enemyPool;
	protected Pool<Efect> efectPool;
